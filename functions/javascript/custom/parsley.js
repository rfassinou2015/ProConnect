...
// eg: `data-parsley-stop-on-first-failing-constraint="false"`
  var ParsleyDefaults = {
    ...
    excluded: 'input[type=button], input[type=submit], input[type=reset], input[type=hidden], #s2id_autogen1,.excludeparsley',
      ...
      for (var i = 0; i < formInstance.fields.length; i++)
        if (true !== formInstance.fields[i].validationResult && formInstance.fields[i].validationResult.length > 0 && 'undefined' === typeof formInstance.fields[i].options.noFocus) {
          if ('first' === formInstance.options.focus) {
			...
			$('html, body').scrollTop($(formInstance._focusedField).offset().top - 121);
...
window.ParsleyConfig.i18n.en = $.extend(window.ParsleyConfig.i18n.en || {}, {
  ...
  minlength:      "Please enter a minimum of %s characters.",
  maxlength:      "This value is too long. It should have %s characters or less.",
  length:         "Please enter a minimum of %s characters.",
